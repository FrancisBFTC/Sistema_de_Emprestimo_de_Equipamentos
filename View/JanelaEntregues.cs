...
{
    public partial class JanelaEntregues : Form
    {
        public ContextMenuStrip menuStrip;
        public DataGridView dataGridView;
        TextBox textBox;

        public JanelaEntregues()
        {
            InitializeComponent();
        }

        private void JanelaEntregues_Load(object sender, EventArgs e)
        {
            textProfessor.KeyDown += TextEntregues_KeyDown;
            textEquipamento.KeyDown += TextEntregues_KeyDown;
            UpdateTable("", true);
        }

        private void TextEntregues_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void UpdateTable(String nomeText, bool isAllData)
        {
            ...
            if (isAllData)
                consulta = new Emprestimo().ColetarEntregues();
            else
                consulta = new Emprestimo(nomeText).Verificar("Entregues");
            ...
            listaEntregues.Controls.Add(dataGridView);
